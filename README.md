...
### Flushing to a .ttarch2 (ttarch2 support in next release!)
...
//making it slightly more efficient. DO NOT set it to true if you are going to keep the entries! Use only when you are deleting the old archive, if you want to create //one then just create a new instance of the TTArchive2Flushabl struct.
