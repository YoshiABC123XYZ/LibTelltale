...
//taken [most of] the encryption keys from ttarchext :D - must have been a pain trying to find them. however i did find them in the .exe below some tt data structs

//Helps me keep track of how many there are. In total this is the amount of games supported
#define KEY_COUNT 65 
